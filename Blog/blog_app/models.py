...
class Blog(models.Model):
    ...
    tags = models.CharField(max_length=264,verbose_name="Put a tag ",null=True)
...
class Reviews(models.Model):
    blog = models.ForeignKey(Blog,on_delete=models.CASCADE,related_name='review_blog',null=True)
    ...
    rating = models.IntegerField(choices=choice,default=5)
    def __str__(self):
...
class Reader(models.Model):
    reader = models.ForeignKey(User, on_delete=models.CASCADE, related_name='reader',null=True)
